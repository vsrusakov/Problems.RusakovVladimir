namespace Calculator
{
    ...
    public class Tokenizer
    {
        ...
        public static Queue<Token> Tokenize(string input)
        {
            ...
            string input_spacedel = input.Replace(" ", "");
    ...
    public class RPN
    {
        ...
        {
            // функция для нахождения ОПЗ с помощью алгоритма сортировочной станции
    ...
    public class Calculator
    {
        ...
        {
            // функция для подсчета значения выражения в ОПЗ
        ...
        {
            // функция для запуска калькулятора из консоли
        ...
        {
            // основная функция для вычисления значения выражения поданной строки
